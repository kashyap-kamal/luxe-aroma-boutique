            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  ...
                  delicate balance of science and creativity that has the power
                  to transport, inspire, and transform. Our mission is to create
          ...
          <div className="luxury-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center p-6 rounded-lg hover:bg-luxe-cream transition-colors">
                ...
                <p className="text-gray-600">
                  We honor traditional perfumery techniques while embracing
                  modern innovation.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-lg mb-6 leading-relaxed">
                  ...
                  world's most exquisite fragrances to discerning customers.
                  What started as a small boutique has grown into a respected
                  name in luxury perfumery, known for our commitment to quality
                  and innovation.
                </p>
                <p className="text-lg mb-6 leading-relaxed">
                ...
                <p className="text-lg leading-relaxed">
                  Today, we continue to push the boundaries of perfumery,
                  creating fragrances that are not just scents, but experiences
          ...
          <div className="luxury-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our master perfumers blend ingredients with precision,
                  creating harmonious compositions that evolve beautifully on
                  the skin. Each fragrance undergoes hundreds of iterations
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  With over 20 years of experience in luxury perfumery,
                  Alexandre brings his passion for exceptional fragrances to
                  every creation.
                </p>
              </div>
        ...
        <section className="py-20 bg-luxe-blue text-white">
          <div className="luxury-container text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Discover our collection of luxury fragrances and find your
              signature scent. Each bottle tells a story of passion,
