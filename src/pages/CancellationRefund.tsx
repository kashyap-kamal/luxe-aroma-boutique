 ...
 * Comprehensive policy for returns, exchanges, and refunds
 */
          ...
          <div className="prose prose-lg max-w-4xl mx-auto">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      You can cancel your order for free within 2 hours of
                      placing it, provided it hasn't been processed for
                      shipping.
                    </p>
                  </div>
                </div>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                ...
                <li>
                  <strong>Package Items:</strong> Pack items securely in
                  original packaging
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>
                  <strong>Net Banking:</strong> Refunds typically processed
