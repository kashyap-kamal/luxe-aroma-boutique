 ...
 * Comprehensive information about shipping options, delivery times, and policies
 */
        ...
        <div className="luxury-container">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Fast, reliable delivery across India with multiple shipping
              options.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    ...
                    <li>
                      • <strong>Cost:</strong> Rs 300 (Rs 200 on orders Rs
                      2000+)
                    </li>
                    <li>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm text-gray-700">
                    Delivery person may request ID verification for
                    age-restricted products (18+ items).
                  </p>
                </div>
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-sm text-gray-700">
                    Available upon request. Package will be left at your
                    doorstep with photo confirmation.
                  </p>
                </div>
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                ...
                <p className="text-sm text-blue-700">
                  All delivery personnel follow safety protocols including
                  masks, sanitization, and contactless delivery options to
                  ensure your safety.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <ul className="space-y-2 text-red-800 text-sm">
                  ...
                  <li>
                    • Signature may be required for high-value orders (Rs
                    5,000+)
                  </li>
                  <li>
