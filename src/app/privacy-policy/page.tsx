    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-luxe-aliceBlue py-8">
        <div className="luxury-container">
          ...
          <h1 className="text-4xl md:text-5xl font-poppins font-black text-luxe-blue mb-4">
            Privacy Policy
          </h1>
          <p className="text-lg text-gray-600">Last updated: July 20, 2025</p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <p className="text-gray-700 mb-8">
            ...
            <a
              ...
              className="text-luxe-blue hover:text-luxe-sandy underline"
            >
          ...
          <h2 className="text-2xl font-bold text-luxe-blue mt-12 mb-6">
            Interpretation and Definitions
          </h2>

          <h3 className="text-xl font-semibold text-luxe-blue mt-8 mb-4">
            Interpretation
          </h3>
          ...
          <ul className="list-disc pl-6 space-y-3 mb-8">
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Arome Luxe, A5
                901 Olive County Vasundhara Ghaziabad - 201010.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Arome Luxe, accessible from{" "}
                <a
          ...
          <h4 className="text-lg font-semibold text-luxe-blue mt-6 mb-3">
            Personal Data
          </h4>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-8">
            <li>
              By email:{" "}
              <a
                href="mailto:contact@aromeluxe.in"
                className="text-luxe-blue hover:text-luxe-sandy underline"
              >
